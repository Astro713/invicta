...
class DiscourseAPI {
	 ...
	 * @throws Exception
	 */
	public function createPost( string $bodyText, int $topicId, string $userName, DateTime $createDateTime = null ): stdClass {
		$params = [
			'raw'       => $bodyText,
			'archetype' => 'regular',
			'topic_id'  => $topicId,
	 ...
	 * @throws Exception
	 */
	public function getTopic( $topicIdOrSlug, $params = [] ): stdClass {
		return $this->_getRequest( "/t/{$topicIdOrSlug}.json", $params );
	}
